...
public class TaimabaAntispam {
    ...
    public TaimabaAntispam(HttpUrl url) {
        this.url = url;
    }
    ...
    public Map<String, String> get() {
        ...
        try {
            ...
            Logger.e(TAG, "IOException parsing taimaba bot fields", e);
        } catch (NullPointerException e) {
            Logger.e(TAG, "NullPointerException parsing taimaba bot fields", e);
        }

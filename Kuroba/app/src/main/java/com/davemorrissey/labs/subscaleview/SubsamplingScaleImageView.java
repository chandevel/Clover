...
public class SubsamplingScaleImageView
    ...
    // A global preference for bitmap format, available to decoder classes that respect it; defaulted to ARGB_8888
    ...
    private void setGestureDetector(final Context context) {
        this.detector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
                if (panEnabled && readySent && vTranslate != null && e1 != null && e2 != null && (Math.abs(e1.getX()
                        - e2.getX()) > 50 || Math.abs(e1.getY() - e2.getY()) > 50) && (Math.abs(velocityX) > 500
        ...
        if (anim != null && !anim.interruptible) {
            ...
            if (anim != null && anim.listener != null) {
                try {
                    ...
                    Logger.w(this, "Error thrown by animation listener", e);
                }
            }
            anim = null;
        }
    ...
    private static class TilesInitTask
        ...
        protected int[] doInBackground(Void... params) {
            try {
                ...
                Logger.e(this, "Failed to initialise bitmap decoder", e);
                this.exception = e;
            }
            return null;
        }
    ...
    private static class TileLoadTask
        ...
        protected Bitmap doInBackground(Void... params) {
            try {
                ...
                Logger.e(this, "Failed to decode tile", e);
                this.exception = e;
            } catch (OutOfMemoryError e) {
                Logger.e(this, "Failed to decode tile - OutOfMemoryError", e);
    ...
    private static class BitmapLoadTask
        ...
        protected Integer doInBackground(Void... params) {
            try {
                ...
                Logger.e(this, "Failed to load bitmap - OutOfMemoryError", e);
                this.exception = new RuntimeException(e);
            }
            return null;
        }
    ...
    private synchronized void onImageLoaded(Bitmap bitmap, int sOrientation, boolean bitmapIsCached) {
        // If actual dimensions don't match the declared size, reset everything.
        if (source != null && source.getSWidth() > 0 && source.getSHeight() > 0 && (source.getSWidth()
                != bitmap.getWidth() || source.getSHeight() != bitmap.getHeight())) {
            reset(false);
        }
                ...
                if (cursor != null) {
                    if (cursor.moveToFirst()) {
                        ...
                        if (VALID_ORIENTATIONS.contains(orientation) && orientation != ORIENTATION_USE_EXIF) {
                            ...
                            Logger.w(this, "Unsupported orientation: " + orientation);
                        }
                    }
                }
            } catch (Exception e) {
                Logger.w(this, "Could not get orientation of image from media store");
            } finally {
                if (cursor != null) {
                    cursor.close();
                }
